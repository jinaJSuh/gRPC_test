...
// Add after compile 
//.proto 파일을 compile 하면 생성되는 파일  :  pb.go  _grpc.pb.go
// pb.go : 네트워크를 통해 message 를 송수신 할때 필요한 code 들이 생성된다. 
//_grpc.pb.go : client 가 call 하고 server 가 구현 하여야 하는 RPC stub 이 generate 된다. 
//**********************************************************************
...
type Feature struct {
	...
	Name     string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`         // The name of the feature.
